...
<div class="col-lg-6">
<span class="logo">Try Yourself</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
...
<div class="col-md-10">
<a href="mailto:latifmutlu@gmail.com" style="color:#000000">latifmutlu@gmail.com</a><br /><br />
...
<a href="https://www.facebook.com/latif.mutlu.32" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/profil.jpg" width=100 height=100 alt="Latif Mutlu" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/latif.mutlu.32" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Latif Mutlu</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+905511707701</h4>
		<h4 style="font-family:'typo' ">latifmutlu@gmail.com</h4>
		<h4 style="font-family:'typo' ">Suleyman Demirel Universitesi,ISPARTA</h4></div></div>
		</p>
      </div>
